@ Kanyon Phillips 
@ Homework 2, unused parts of original file commented out
@ Filename: homework2.s
...
@    as -o homework2.o homework2.s
@    gcc -o homework2 homework2.o
@    ./homework2 ;echo $?
@    gdb --args ./homework2 
...
@ Changes made for the assignment start here
   mov r1, #1 
   mov r4, r1
   mov r5, #1
counting:   
...
.balign 4
finished: .asciz "happily finished \n"
